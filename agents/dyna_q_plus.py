...
class DynaQPlus(Agent):
    ...
    def __init__(self, num_states, num_actions, config):
        ...
        self.time_counter = 0
        self.kappa = config.get("kappa", 1e-1)
        self.last_tried = defaultdict(int) # state, action -> last time when this combo was explored
    ...
    def start(self, state):
        ...
        self.last_tried[(self.last_state, self.last_action)] = self.time_counter
    ...
    def planning_step_func(self):
        ...
        for planning_step in range(self.planning_steps):
            ...
            tau = self.time_counter - self.last_tried[(random_state, random_action)]
